...
class Rockets_bdf(models.Model):
    ...
    #Количество узлов ракеты (с шагом k = 0.1)
    N = models.DecimalField(decimal_places=1, max_digits=12, help_text="(с шагом k = 0.1)", verbose_name='Количество узлов ракеты')
